...
export default function Nav() {
  ...
  return (
    ...
    >
      ...
      {open && (
        <nav className="md:hidden flex flex-col gap-4 border-b border-line bg-white px-6 py-5 shadow-md">
          {LINKS.map((link) => (
            <a
              key={link.href}
              href={link.href}
