        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {CASES.map((item, i) => (
            <Reveal key={item.name} delay={i * 80} as="article">
              <div className="h-full rounded-[10px] border border-line bg-white p-7 shadow-sm transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-1.5 hover:shadow-md">
                ...
                <p className="mb-5 text-[0.92rem] text-gray-500">{item.desc}</p>
